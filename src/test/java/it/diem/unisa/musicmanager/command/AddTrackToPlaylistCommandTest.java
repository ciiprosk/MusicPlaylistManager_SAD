...
class AddTrackToPlaylistCommandTest {
    ...
    void setUp() {
        ...
        command = new AddTrackToPlaylistCommand(playlistService, playlist.getId(), track.getId(), track.getTitle(), playlist.getName());
    }

    @Test
    void testUndoRemovesAddedTrackFromPlaylistArchive() {
